...
class App(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("NHÓM OS_MEM_07 - First-Fit Simulator")
        ...
        ctk.CTkLabel(self.sidebar, text="THUẬT TOÁN: FIRST-FIT", font=("Roboto", 14, "bold"), fg_color="#e74c3c", corner_radius=5).pack(pady=10, padx=20, fill="x", ipady=5)
